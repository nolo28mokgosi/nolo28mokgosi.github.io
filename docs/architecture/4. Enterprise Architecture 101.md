...
Strong enterprise architecture comprises all the technology—networks, hardware, software, systems, and services—that makes executing that strategy possible. 
